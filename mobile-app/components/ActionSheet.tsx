...
export default function ActionSheet({ visible, onClose, onSelect }: ActionSheetProps) {
    const actions = [
        { id: 'image', icon: ImageIcon, label: 'Subir Imagen', color: '#3b82f6' },
        { id: 'ex-simulator', icon: MessageSquare, label: 'Ex Simulator', color: '#ec4899' },
        { id: 'decoder', icon: Search, label: 'Decodificador', color: '#8b5cf6' },
        { id: 'conversation', icon: BarChart2, label: 'Analizar Chat', color: '#10b981' },
        { id: 'social', icon: Smartphone, label: 'Analizar Redes', color: '#f59e0b' },
        { id: 'stalker', icon: Eye, label: 'Detector Stalker', color: '#ef4444' },
