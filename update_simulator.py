...
# Read the file
file_path = r'd:\TODO\MY EX\my-ex-coach\mobile-app\app\(tabs)\index.tsx'
with open(file_path, 'r', encoding='utf-8') as f:
    lines = f.readlines()

# Find and replace the AI footer section
new_lines = []
skip_until = -1
...
for i, line in enumerate(lines):
    ...
    if '{/* AI Label + Report Button' in line:
        ...
        new_lines.append('                                                    { text: \'🚩 Reportar contenido inapropiado\', onPress: async () => { await reportAIContent(`sim_msg_${idx}`, msg.content, \'ex_simulator\', \'current_user_id\'); } },\n')
